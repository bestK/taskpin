...
local sprite_walk   = "examples/sprite-sheet/luna/walk.png"
local sprite_attack = "examples/sprite-sheet/luna/attack.png"
...
local ANIM = {
    ...
    walk_up     = { sheet = "walk",   row = 1, frames = 5, speed = 4, scale = 0.7 },
    walk_down   = { sheet = "walk",   row = 4, frames = 5, speed = 4 },
    walk_ul     = { sheet = "walk",   row = 0, frames = 5, speed = 4, scale = 0.85 },
    walk_ur     = { sheet = "walk",   row = 2, frames = 5, speed = 4, scale = 0.85 },
...
local draw_w = math.floor(luna_w * scale)
local draw_h = math.floor(luna_h * scale)

local state_label = { idle = "待机", walk = "漫步", chase = "追踪", attack = "施法" }
